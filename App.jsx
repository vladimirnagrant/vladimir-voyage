...
function playPianoIntro() {
  try {
    ...
    const pianoNote = (freq, start, duration, peak) => {
    ...
    // Temps 1 : une note grave, en suspension — le "ta…"
    pianoNote(196.0, now, 0.9, 0.16); // Sol grave

    // Temps 2 : un accord plein qui arrive juste après — le "DUM"
    const chordStart = now + 0.55;
    [261.63, 329.63, 392.0, 523.25].forEach((freq) => pianoNote(freq, chordStart, 2.6, 0.2));
