...
/* ---------------- 3D INTERACTIVE GLOBE ---------------- */
const WORLD_GEO_URL = "https://unpkg.com/world-atlas@2.0.2/countries-50m.json";
...
function Globe({ countries, onSelect }) {
  ...
  // Charge les frontières du monde (une seule fois)
  useEffect(() => {
    let cancelled = false;
    (async () => {
      try {
        ...
        if (cancelled) return;
        const geo = topojson.feature(topoRes, topoRes.objects.countries);
