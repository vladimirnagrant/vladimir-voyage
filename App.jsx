...
const styles = {
  ...
  heroNameLayer: {
    position: "absolute", top: "7%", left: 0, right: 0, zIndex: 2,
    display: "flex", flexDirection: "column", alignItems: "center", pointerEvents: "none",
  },
  heroGiantName: {
    display: "block", width: "100%", textAlign: "center",
    fontFamily: "Arial, sans-serif", fontWeight: 900, textTransform: "uppercase",
    fontSize: "clamp(58px, 21vw, 200px)", lineHeight: 0.86, letterSpacing: -1,
    color: "#FFFFFF38",                          // blanc très transparent : on voit le visage à travers
    WebkitTextStroke: "1.5px #FFFFFF66",         // léger contour pour lisibilité
    textShadow: "0 2px 30px #00000055",
  },
  heroGiantNameLast: {
    color: "#FFFFFF26",
    WebkitTextStroke: "1.5px #FFFFFF55",
  },
