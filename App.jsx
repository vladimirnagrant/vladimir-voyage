...
function Globe({ countries, onSelect }) {
  ...
  // On charge la carte du monde, mais on ne GARDE que les pays visités.
  // Dessiner 240 pays en 3D est trop lourd pour un téléphone ; en ne gardant
  // que les tiens (surlignés, cliquables en entier), le globe redevient fluide.
  useEffect(() => {
    let cancelled = false;
    (async () => {
      try {
  ...
  // Applique les frontières (uniquement les pays visités, tous en doré et cliquables)
  useEffect(() => {
