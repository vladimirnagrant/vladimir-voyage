    ...
    <div style={styles.app}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @keyframes heroPhotoIn { from { opacity: 0; transform: scale(1.06); } to { opacity: 0.85; transform: scale(1); } }
        @keyframes heroNameIn { from { opacity: 0; transform: translateY(26px); } to { opacity: 1; transform: translateY(0); } }
        .hero-photo-in { animation: heroPhotoIn 3.8s ease-out both; }
        .hero-name-in { opacity: 0; animation: heroNameIn 2s ease-out 1.1s both; }
        .hero-name-in-delay { animation-delay: 1.6s; }
        .hero-phrase-delay { animation-delay: 2.1s; }
        .hero-cta-delay { animation-delay: 2.6s; }
